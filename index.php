...
<main>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@300&family=Merriweather:ital,wght@0,300;0,400;0,700;0,900;1,300;1,400;1,700;1,900&display=swap" rel="stylesheet">
    ...
    <section class="info-section">
        ...
        <div class="circle-strip">
            ...
            <div class="circle-item">
                ...
                <p>Этап 1</p>
                <p>Просмотр квартир, сдающихся посуточно в разных районах Казани. Вы можете найти нас также на других платформах Интернета. </p>
            </div>
            <div class="line"></div>
            <div class="circle-item">
                <div class="circle"></div>
                <p>Этап 2</p>
                <p>Выбор подходящего для вас жилья. Ознакомьтесь с описанием, расположением и свободными датами бронирования, подходящей для вас квартиры. </p>
            </div>
            <div class="line"></div>
            <div class="circle-item">
                <div class="circle"></div>
                <p>Этап 3</p>
                <p>Заполнение заявки на желаемую бронь. Не забудьте указать необходимые данные о себе в форме заполнения на бронь квартиры.</p>
            </div>
            <div class="line"></div>
            <div class="circle-item">
                <div class="circle"></div>
                <p>Этап 4</p>
                <p>Ожидайте! В ближайшее время с вами свяжется наш администратор для обсуждения всех интересующих вопросов и нюансов при заселении.</p>
            </div>
            <div class="line"></div>
        </div>
    </section>
